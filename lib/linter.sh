...
# shellcheck disable=SC2034  # Variable is referenced indirectly
SVELTE_FILE_NAME="${JAVASCRIPT_ES_CONFIG_FILE:-.eslintrc.yml}"
# shellcheck disable=SC2034  # Variable is referenced indirectly
...
LANGUAGE_ARRAY=('ANSIBLE' 'ARM' 'BASH' 'BASH_EXEC' 'CLANG_FORMAT'
  ...
  'JAVASCRIPT_ES' "${JAVASCRIPT_STYLE_NAME}" 'JSCPD' 'JSON' 'JSONC' 'JSX' 'SVELTE'
...
LINTER_NAMES_ARRAY['SVELTE']="eslint"
...
LINTER_COMMANDS_ARRAY['SVELTE']="eslint --no-eslintrc -c ${SVELTE_LINTER_RULES}"
